...
import { Commander } from "./apps/commander/Commander";
...
const TestMfe1 = lazy(() => import("remoteFrontend1/Mfe").then((module) => ({ default: module.Mfe })));
const TestMfe2 = lazy(() => import("remoteFrontend2/Mfe").then((module) => ({ default: module.Mfe })));
...
export const apps: App[][] = [
	[
		...
		{ id: "commander", roles: ["admin", "user", "guest"], title: <T>{lang.commander.title}</T>, icon: "commander", component: <Commander /> },
	],
	[
