...
export const themeLight: ITheme = {
	...
	color: {
		...
		primaryBgHover: "#c6c6c688",
		primaryFgActive: "#000000",
		primaryBgActive: "#a9a9a9",
		primaryFgSelected: "#333333",
		primaryBgSelected: "#F3F2F8",
