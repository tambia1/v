...
test("Desktop", async ({ page }) => {
	...
	await expect(page).toHaveScreenshot("desktop_guest_page_1.png");

	await performSwipe(page, "rightToLeft");
	await expect(page).toHaveScreenshot("desktop_guest_page_2.png");
	...
	await expect(page).toHaveScreenshot("desktop_loged_in.png");
});
