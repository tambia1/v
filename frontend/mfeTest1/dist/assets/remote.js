...
let moduleMap = {
  "./Mfe": () => {
    dynamicLoadingCss(["style-yutavFy1.css"], false, "./Mfe");
    return __federation_import("/v/assets/__federation_expose_Mfe-DTWPrND4.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }
};
const seen = {};
